...
#     command = "./ns3 run \"scratch/SimulatorScript.cc --stopTime=200 --flowStartOffset=100 --appendFlow={} --appendFlow2={} --queueBDP={} --botLinkDelay={} --p2pLinkDelay=2.5 --path=fairnessafter100secs/bw{}/delay{}/qmult{}/flows2/{}/run{} --seed={}\"".format(protocol, protocol, mult, delay, bw, delay, mult, protocol, run, run)
     ...
     for bw in BWS:
        for delay in DELAYS:
           ...
           if len(goodput_ratios_total) > 0:
              goodput_ratios_20 = pd.concat(goodput_ratios_20, axis=0)
